...
export const bibleBlocks: BibleBlock[] = [
  ...
  },
  {
    ...
    "rows": [
      ...
      [
        ...
        "нет",
        "Логотип организации. Есть у фондов и НКО и у Яндекса (`yandex`). У частных компаний поля нет."
      ],
      [
        "`photo`",
        "имя файла без расширения",
  ...
  {
    "id": "bible::raskladka-i-otdelnye-komponenty::table::gmya9z",
    "kind": "table",
    "header": [
      "Правило",
      "Степень",
