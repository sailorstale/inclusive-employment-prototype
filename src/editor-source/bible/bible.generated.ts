...
export const bibleBlocks: BibleBlock[] = [
  ...
  {
    "id": "bible::stranica::code::1nk9edv",
    "kind": "code",
    "lang": "json",
  ...
  {
    "id": "bible::stranica::table::1hazrrm",
    "kind": "table",
    "header": [
      "Поле",
      "Тип",
  ...
  {
    "id": "bible::quote::para::1y39soa",
    "kind": "para",
    "md": "**Речь едет одним полем `text`, как у любого другого текста.** До 17 августа 2026 у цитаты был массив `paragraphs` — по абзацу на строку, — и цитата оставалась единственным компонентом со своим устройством текста. Разработчик попросил привести её к общему виду.",
    "text": "Речь едет одним полем text, как у любого другого текста. До 17 августа 2026 у цитаты был массив paragraphs — по абзацу на строку, — и цитата оставалась единственным компонентом со своим устройством текста. Разработчик попросил привести её к общему виду."
  },
  {
    "id": "bible::quote::para::kll35u",
    "kind": "para",
    "md": "Правило разметки то же, что везде: одна фраза едет голой строкой, а всё, что сложнее, — тегами блоков. Цитата в несколько абзацев со списком внутри выглядит так:",
    "text": "Правило разметки то же, что везде: одна фраза едет голой строкой, а всё, что сложнее, — тегами блоков. Цитата в несколько абзацев со списком внутри выглядит так:"
  },
  {
