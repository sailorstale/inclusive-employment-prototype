...
export const bibleBlocks: BibleBlock[] = [
  ...
  {
    "id": "bible::stranica::code::qzam1d",
    "kind": "code",
    "lang": "json",
    "body": "{\n  \"slug\": \"/ngo/guidance\",\n  \"navTitle\": \"Профориентация\",\n  \"navGroup\": \"Соискатели\",\n  \"meta\": {\n    \"title\": \"Профориентация — Инклюзия в Яндексе\",\n    \"description\": \"Как НКО помогает кандидату выбрать направление работы…\",\n    \"favicon\": \"https://avatars.mds.yandex.net/get-lpc/12602567/c91d96c9-c7de-4f9a-917d-d882cceb0405/orig?width=0&height=0\"\n  },\n  \"meta-og\": {\n    \"title\": \"Профориентация — Инклюзия в Яндексе\",\n    \"description\": \"Как НКО помогает кандидату выбрать направление работы…\",\n    \"image\": \"https://avatars.mds.yandex.net/get-lpc/14837328/f312cac0-c75e-4ecc-bc53-62c7ff466579/orig?width=1200&height=630\"\n  },\n  \"h1\": \"Профориентация\",\n  \"article\": []\n}",
    "text": "{\n  \"slug\": \"/ngo/guidance\",\n  \"navTitle\": \"Профориентация\",\n  \"navGroup\": \"Соискатели\",\n  \"meta\": {\n    \"title\": \"Профориентация — Инклюзия в Яндексе\",\n    \"description\": \"Как НКО помогает кандидату выбрать направление работы…\",\n    \"favicon\": \"https://avatars.mds.yandex.net/get-lpc/12602567/c91d96c9-c7de-4f9a-917d-d882cceb0405/orig?width=0&height=0\"\n  },\n  \"meta-og\": {\n    \"title\": \"Профориентация — Инклюзия в Яндексе\",\n    \"description\": \"Как НКО помогает кандидату выбрать направление работы…\",\n    \"image\": \"https://avatars.mds.yandex.net/get-lpc/14837328/f312cac0-c75e-4ecc-bc53-62c7ff466579/orig?width=1200&height=630\"\n  },\n  \"h1\": \"Профориентация\",\n  \"article\": []\n}"
  },
  {
  ...
  {
    "id": "bible::meta::para::c1rjmj",
    "kind": "para",
    "md": "`meta` — три поля: `title`, `description`, `favicon`.",
    "text": "meta — три поля: title, description, favicon."
  },
  {
    "id": "bible::meta::para::10kqv8d",
    "kind": "para",
    "md": "`meta-og` — три поля: `title`, `description`, `image`. Картинка карточки размером 1200 на 630 точек: столько показывает мессенджер, когда разворачивает ссылку в чате.",
    "text": "meta-og — три поля: title, description, image. Картинка карточки размером 1200 на 630 точек: столько показывает мессенджер, когда разворачивает ссылку в чате."
  },
  {
    "id": "bible::meta::para::9bngs3",
    "kind": "para",
    "md": "**Значок вкладки и картинка карточки едут ПОЛНЫМИ АДРЕСАМИ, а не именами файлов** (адреса прислал разработчик 17 августа 2026). Это не противоречит правилу логотипов и портретов: те картинки разработчик забирает с прототипа и заводит у себя, поэтому имя файла — единственное, что мы можем ему сказать. А эти две уже лежат в хранилище картинок Яндекса и имеют постоянный адрес.",
    "text": "Значок вкладки и картинка карточки едут ПОЛНЫМИ АДРЕСАМИ, а не именами файлов (адреса прислал разработчик 17 августа 2026). Это не противоречит правилу логотипов и портретов: те картинки разработчик забирает с прототипа и заводит у себя, поэтому имя файла — единственное, что мы можем ему сказать. А эти две уже лежат в хранилище картинок Яндекса и имеют постоянный адрес."
  },
  {
    "id": "bible::meta::para::rzkf0x",
    "kind": "para",
    "md": "Обе картинки одни на весь сайт: сайт один, и в чате он должен выглядеть одинаково, с какой бы страницы ссылку ни кинули.",
    "text": "Обе картинки одни на весь сайт: сайт один, и в чате он должен выглядеть одинаково, с какой бы страницы ссылку ни кинули."
  },
  {
  ...
  {
    "id": "bible::3-pustyh-poley-v-fayle-net::para::yk9aqv",
    "kind": "para",
    "md": "Других исключений нет. До 17 августа 2026 вторым было `image` в `meta-og`: пока картинки для мессенджеров не существовало, поле ехало пустой строкой. Теперь адрес есть, и пустых строк в файле не осталось вовсе.",
    "text": "Других исключений нет. До 17 августа 2026 вторым было image в meta-og: пока картинки для мессенджеров не существовало, поле ехало пустой строкой. Теперь адрес есть, и пустых строк в файле не осталось вовсе."
  },
  {
  ...
  {
    "id": "bible::5-tekst-edet-s-tegami-a-ne-v-markdown::para::2j0po",
    "kind": "para",
    "md": "Одиночный абзац едет голой строкой, без `<p>`: тег там нечего отделять от соседа. Так устроены абзац (`Text`), заголовок, пункт списка и ячейка таблицы — там голые все до одного.",
    "text": "Одиночный абзац едет голой строкой, без <p>: тег там нечего отделять от соседа. Так устроены абзац (Text), заголовок, пункт списка и ячейка таблицы — там голые все до одного."
  },
  {
    "id": "bible::5-tekst-edet-s-tegami-a-ne-v-markdown::para::8d38tg",
    "kind": "para",
    "md": "**У трёх полей правило другое** — там абзац обёрнут всегда, даже когда он один. Это `text` у цитаты (`Quote`), `text` у врезки (`Phrase`) и `description` у квиза. Разнобой возникал именно у них: рядом стоят и длинные тексты в несколько абзацев со списком внутри, и короткие в одну фразу, поэтому часть приезжала с тегами, а часть без. У цитаты правило касается только поля `text`: имя, должность и организация остаются обычными строками.",
    "text": "У трёх полей правило другое — там абзац обёрнут всегда, даже когда он один. Это text у цитаты (Quote), text у врезки (Phrase) и description у квиза. Разнобой возникал именно у них: рядом стоят и длинные тексты в несколько абзацев со списком внутри, и короткие в одну фразу, поэтому часть приезжала с тегами, а часть без. У цитаты правило касается только поля text: имя, должность и организация остаются обычными строками."
  },
  {
  ...
  {
    "id": "bible::phrase::para::11z84c9",
    "kind": "para",
    "md": "В выгрузке семь штук, все размера `L`. Как и проза, кладётся прямо в `Section Container`.",
    "text": "В выгрузке семь штук, все размера L. Как и проза, кладётся прямо в Section Container."
  },
  {
    "id": "bible::phrase::para::b81qfp",
    "kind": "para",
    "md": "**Абзац врезки всегда обёрнут в `<p>`, даже когда он один** — то же исключение, что у цитаты. Шесть врезок из семи приезжали с тегами, а седьмая, короткая, шла голой строкой; теперь все семь одинаковые.",
    "text": "Абзац врезки всегда обёрнут в <p>, даже когда он один — то же исключение, что у цитаты. Шесть врезок из семи приезжали с тегами, а седьмая, короткая, шла голой строкой; теперь все семь одинаковые."
  },
  {
  ...
  {
    "id": "bible::quote::para::vy549x",
    "kind": "para",
    "md": "**Правило касается только `text`.** Имя автора, должность и организация — обычные строки, и `<p>` в них не бывает. Единственный тег, который там встречается, — ссылка на сайт фонда внутри должности, она стоит у 22 цитат из 41.",
    "text": "Правило касается только text. Имя автора, должность и организация — обычные строки, и <p> в них не бывает. Единственный тег, который там встречается, — ссылка на сайт фонда внутри должности, она стоит у 22 цитат из 41."
  },
  {
  ...
  {
    "id": "bible::quiz::para::mo4c94",
    "kind": "para",
    "md": "Блок самопроверки: вопрос, варианты ответа и разбор. Берут после куска обучающего материала. Не берут для сбора данных — это форма, а не квиз. Кнопка «Проверить» есть не у всех, см. ниже.",
    "text": "Блок самопроверки: вопрос, варианты ответа и разбор. Берут после куска обучающего материала. Не берут для сбора данных — это форма, а не квиз. Кнопка «Проверить» есть не у всех, см. ниже."
  },
  {
    "id": "bible::quiz::table::8x5glq",
    "kind": "table",
    "header": [
      "Поле",
      "Значения",
    ...
    "rows": [
      ...
      [
        ...
        "строка с тегами",
        "нет",
        "Вводный текст перед вопросом, бывает из нескольких абзацев и списков. Абзац всегда обёрнут в `<p>`, даже если он один. Есть у 12."
      ],
      [
        "`explanation`",
        "строка с тегами",
    ...
    "text": "Поле | Значения | Обяз. | Что значит | component | \"Quiz\" | да |  | items | массив вариантов | да | См. ниже. | mode | single · multiple | да | Один верный вариант или несколько. Руками не проставляется — считается по числу верных вариантов, поэтому разъехаться с содержанием не может. Из 55 квизов 46 с одним верным ответом, 9 с несколькими. | question | строка с тегами | нет | Вопрос. Есть у 50 квизов из 55: у квиза-темы вопрос целиком в заголовке. | title | строка с тегами | нет | Заголовок темы. Есть у 21. | description | строка с тегами | нет | Вводный текст перед вопросом, бывает из нескольких абзацев и списков. Абзац всегда обёрнут в <p>, даже если он один. Есть у 12. | explanation | строка с тегами | нет | Разбор после проверки. Есть у 43."
  },
  {
    "id": "bible::quiz::para::1nuuq1z",
    "kind": "para",
    "md": "**Строка-вердикт считается сама, поля для неё нет.** Над разбором стоит одно слово — «Верно», «Неверно» или «Частично верно». Оно выводится из того, что отметил читатель, и из пометок `correct` у вариантов, то есть из данных, которые в файле уже есть.",
    "text": "Строка-вердикт считается сама, поля для неё нет. Над разбором стоит одно слово — «Верно», «Неверно» или «Частично верно». Оно выводится из того, что отметил читатель, и из пометок correct у вариантов, то есть из данных, которые в файле уже есть."
  },
  {
    "id": "bible::quiz::table::1a8pk75",
    "kind": "table",
    "header": [
      "Что отметил читатель",
      "Вердикт"
    ],
    "rows": [
      [
        "Все верные варианты и ни одного неверного",
        "Верно"
      ],
      [
        "Ни одного верного, только неверные",
        "Неверно"
      ],
      [
        "И верные, и неверные вперемешку",
        "Частично верно"
      ],
      [
        "Один верный, хотя верных в квизе несколько",
        "Частично верно"
      ]
    ],
    "text": "Что отметил читатель | Вердикт | Все верные варианты и ни одного неверного | Верно | Ни одного верного, только неверные | Неверно | И верные, и неверные вперемешку | Частично верно | Один верный, хотя верных в квизе несколько | Частично верно"
  },
  {
    "id": "bible::quiz::para::1vtev54",
    "kind": "para",
    "md": "Строка показывается у каждого квиза, где есть хотя бы один верный вариант. Там, где верных нет вовсе, судить нечего: это самопроверка, и вердикта у неё не бывает.",
    "text": "Строка показывается у каждого квиза, где есть хотя бы один верный вариант. Там, где верных нет вовсе, судить нечего: это самопроверка, и вердикта у неё не бывает."
  },
  {
    "id": "bible::quiz::para::173w4e5",
    "kind": "para",
    "md": "До 17 августа 2026 в файле ехало поле `noVerdict`, которое эту строку прятало. Оно стояло у 30 квизов, но список страниц мы вели руками, и по файлу понять его было нельзя: одно и то же слово в одном месте появлялось, в другом нет. Поле убрано, правило стало одно на все квизы.",
    "text": "До 17 августа 2026 в файле ехало поле noVerdict, которое эту строку прятало. Оно стояло у 30 квизов, но список страниц мы вели руками, и по файлу понять его было нельзя: одно и то же слово в одном месте появлялось, в другом нет. Поле убрано, правило стало одно на все квизы."
  },
  {
    "id": "bible::quiz::para::cd4wlo",
    "kind": "para",
    "md": "**Кнопка «Проверить» есть только там, где верных вариантов несколько.** Она выводится из `mode`, своего поля у неё нет. Смысл кнопки — сказать «я закончил выбирать»: пока вариантов можно отметить несколько, без неё непонятно, когда показывать разбор. При одном верном ответе выбор и есть окончание, поэтому разбор появляется сразу по клику, а лишнее нажатие только отделяло бы вопрос от ответа. Значит кнопка есть у 9 квизов из 55 и нет у 46.",
    "text": "Кнопка «Проверить» есть только там, где верных вариантов несколько. Она выводится из mode, своего поля у неё нет. Смысл кнопки — сказать «я закончил выбирать»: пока вариантов можно отметить несколько, без неё непонятно, когда показывать разбор. При одном верном ответе выбор и есть окончание, поэтому разбор появляется сразу по клику, а лишнее нажатие только отделяло бы вопрос от ответа. Значит кнопка есть у 9 квизов из 55 и нет у 46."
  },
  {
    "id": "bible::quiz::para::wyl98h",
    "kind": "para",
    "md": "До 17 августа 2026 в файле ехало поле `instant`, и оно врало: без кнопки работали шестнадцать квизов, а поле называло четыре. Остальные двенадцать прототип угадывал по тому, что у каждого варианта есть свой разбор, и разработчику об этом не говорил. Поле убрано, правило стало одно на все квизы.",
    "text": "До 17 августа 2026 в файле ехало поле instant, и оно врало: без кнопки работали шестнадцать квизов, а поле называло четыре. Остальные двенадцать прототип угадывал по тому, что у каждого варианта есть свой разбор, и разработчику об этом не говорил. Поле убрано, правило стало одно на все квизы."
  },
  {
  ...
  {
    "id": "bible::tri-vida-stroki-otveta-i-otkuda-oni-berutsya::para::novm9y",
    "kind": "para",
    "md": "Строка-вердикт над разбором собирается по тому же принципу и тоже из данных, а не из поля, — правило подсчёта в таблице выше, в описании полей `Quiz`.",
    "text": "Строка-вердикт над разбором собирается по тому же принципу и тоже из данных, а не из поля, — правило подсчёта в таблице выше, в описании полей Quiz."
  },
  {
  ...
  {
    "id": "bible::zhdem-materialov::para::1cjf69i",
    "kind": "para",
    "md": "Значок вкладки и картинка для карточки в мессенджерах пришли 17 августа 2026, оба поля заполнены адресами. Семь фотографий авторов цитат заказчик пока не прислал: имена файлов мы придумали заранее и положили под ними серые силуэты, поэтому верстать можно уже сейчас — когда фотографии придут, мы просто перезапишем файлы под теми же именами, и в выгрузке ничего не изменится.",
    "text": "Значок вкладки и картинка для карточки в мессенджерах пришли 17 августа 2026, оба поля заполнены адресами. Семь фотографий авторов цитат заказчик пока не прислал: имена файлов мы придумали заранее и положили под ними серые силуэты, поэтому верстать можно уже сейчас — когда фотографии придут, мы просто перезапишем файлы под теми же именами, и в выгрузке ничего не изменится."
  },
  {
