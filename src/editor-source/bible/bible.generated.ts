...
export const bibleBlocks: BibleBlock[] = [
  ...
  {
    "id": "bible::table-cell::para::w0mr6b",
    "kind": "para",
    "md": "**Объединять можно любые ячейки, а не только первую колонку.** Правило то же, что в вёрстке таблицы: ячейка с объединением несёт `rowSpan` или `colSpan`, а поглощённые ею ячейки в строку не едут вовсе. Поэтому строка под объединением короче остальных, и это нормально — считать ширину строки нужно с учётом объединений.",
    "text": "Объединять можно любые ячейки, а не только первую колонку. Правило то же, что в вёрстке таблицы: ячейка с объединением несёт rowSpan или colSpan, а поглощённые ею ячейки в строку не едут вовсе. Поэтому строка под объединением короче остальных, и это нормально — считать ширину строки нужно с учётом объединений."
  },
  {
