...
/*
  ...
  оформление», один на «Льготы сотрудников», три на «Форматы занятости» и один
  на «Квоты и господдержку». Если ключ перестанет совпадать, на странице вместо
...
const QUIZ_PAGES: Record<string, string[]> = {
  ...
  // Три квиза про ГПХ и самозанятость уехали вместе со своей темой на
  // отдельную страницу «Форматы занятости» (правка клиента 5 августа 2026).
