/*
  ...
  В JSON едет внутри meta простой строкой: { meta: { …, image: "адрес" } } —
  просьба разработчика от 5 августа. Пока пусто: заполняется по мере появления
  ассетов, пустой адрес на сайте не рисуется, но место в структуре
  зарезервировано под каждую страницу.
