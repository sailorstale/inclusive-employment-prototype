    ...
    */
    ...
    outline: {
      /*
        ...
        цитаты. 8 сентября дизайнер решил цитату убрать совсем, поэтому теперь
        строка просто уходит, и ничего на её место не встаёт (история — в
        appliedComments.ts, три записи на msq1kyba9ac4).
