...
export const MOVED_DOCS: MovedDoc[] = [
  ...
  */
  ...
  /*
    ПРОМПТ ПРО ОФОРМЛЕНИЕ ДОГОВОРА — «Форматы занятости». В таблице заказчика
    строка была без старого адреса, поэтому в сверке 23 августа осталась под
    вопросом. Новый адрес прислал Митя 16 сентября 2026 — ссылка вида /edit/d/,
    а не /i/: так Диск отдаёт документ на просмотр.
  */
  /*
    ПАМЯТКА ПРО ОБЩЕНИЕ С ГЛУХИМИ И СЛАБОСЛЫШАЩИМИ — «Этика и коммуникация».
    Ссылка стояла в источнике сразу на Диске, поэтому в таблице заказчика её не
    было. Новый адрес прислал Митя 16 сентября 2026; старый тоже яндексовый,
    и опознаватель здесь — код файла после «/i/», как у роликов выше.
  */
  {
    name: "Памятка: общение с глухими и слабослышащими сотрудниками",
  ...
  },
  {
    ...
    href: "https://disk.360.yandex.ru/edit/d/HjRRvcfDdwYa6lzyb-UdSSPegnqahzm72s0qoIz-cKg6TzREdUVtTE1QZw?from_public=1",
  },
];
