...
const BY_NAME = new Map<string, LucideIcon>([
  ...
  */
  ["VolumeX", VolumeX],
  /*
    Ладонь — группа «Сотрудники с особенностями функций рук» на «Шаге 6». Своего
    значка у неё раньше не было: на «Шаге 4» и «Шаге 5» такой группы нет, там
    речь про опорно-двигательный аппарат целиком. Ставится по названию карточки,
    см. cardArt.ts.
  */
  ["Hand", Hand],
  /*
