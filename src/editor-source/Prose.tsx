// Островная копия components/Prose: использует ОСТРОВНОЙ Editable (scope=source),
// иначе абзацы/списки источника ходили бы в сайтовый редактор (пустой) и правки
// не находились. Отличие от оригинала — только импорт Editable и SmartLink.
