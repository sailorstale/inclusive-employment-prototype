...
/*
  ...
  Как ставить в пару: две Compare Card внутри Card Container · Horizontal —
  380 + 8 + 380 = ширина колонки 768. Компонент «Compare» из Figma в шаблоне
  не используется НИ РАЗУ, обе живые пары собраны руками (см. сверку критика,
  п. 6) — поэтому и мы собираем пару контейнером, а не отдельным компонентом.
