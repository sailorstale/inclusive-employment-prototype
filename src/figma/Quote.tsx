...
/*
  ...
  У частных компаний логотипа нет вовсе (проп noLogo, решение дизайнера от
  8 сентября 2026): ни знака, ни заглушки, компания названа в должности.

  ФАЙЛЫ ЛОГОТИПОВ: public/figma/logos/<слаг>.png (588 логотипов фондов
...
type Props = {
  ...
  logo?: string;
  /*
    Логотипа не будет — частная компания (решение дизайнера от 8 сентября 2026).
    Отличие от незаданного logo: там рисуется серый прямоугольник-заглушка под
    будущий знак, здесь не рисуется ничего. Название компании остаётся в
    должности.
  */
  noLogo?: boolean;
