            ...
            : // Ряд карточек: каждая занимает ПОЛОВИНУ колонки, третья переносится
              ...
              [
                ...
                */
                ...
                /*
                  ЛЮДИ ДЕЛЯТ РЯД ПОРОВНУ, сколько бы их ни было, — замечание
                  Мити от 13 августа 2026 про трёх экспертов на «О проекте».
                  Половина колонки — правило для карточек: там внутри абзацы и
                  списки, и в треть колонки они не поместятся. Person Item — это
                  портрет 82 пикселя, имя и должность, и три таких спокойно
                  встают в ряд, а по правилу половинок третий переносился на
                  свою строку и ряд выглядел сломанным.

                  Правило стоит ПОСЛЕ общего и перебивает его. Повторено на
                  уровень глубже по той же причине, что и соседнее: в
                  инструменте сверки между конвертом и блоком стоит обёртка
                  выбора с display:contents.

                  ПОДЧЁРКИВАНИЕ ВМЕСТО ПРОБЕЛА в «Person_Item» — не опечатка.
                  Tailwind собирает классы, разбивая строку по пробелам, и
                  название с пробелом внутри разваливается на два куска: правило
                  просто не рождается, а на странице ничего не меняется. В
                  готовом CSS подчёркивание снова становится пробелом.
                */
                "[&>[data-component='Person_Item']]:basis-0",
                "[&>[data-component='Person_Item']]:grow",
                "[&>.ds-pick>[data-component='Person_Item']]:basis-0",
                "[&>.ds-pick>[data-component='Person_Item']]:grow",
              ].join(" "),
        )}
      >
        {children}
