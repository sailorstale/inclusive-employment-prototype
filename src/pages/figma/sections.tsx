  ...
  return (
    <SectionContainer>
      ...
      <Text size="L">
        ...
        Для обезличенной выделенной мысли берут обычную карточку.
      </Text>
      ...
      <CardContainer>
        ...
        >
          ...
          замеченной, поэтому она перебивает ритм колонки.
        </Quote>
        <Quote size="S" author="Имя Фамилия" role="Должность, НКО" avatars={1}>
          Quote · S — спокойная цитата без подложки, прямо на фоне страницы. Не
          перебивает чтение.
        </Quote>
      </CardContainer>
  ...
  return (
    <SectionContainer>
      ...
      <Text size="L">
        ...
        должен читаться полностью. Здесь все 18 сюжетов набора. В прототипе они
        заменены плейсхолдерами: рисунки из Figma не переносим.
      </Text>
