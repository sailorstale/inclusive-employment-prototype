  ...
  return (
    <SectionContainer>
      ...
      <Block>
        <Prompt
          title="ИИ промпт"
          subtitle="До использования в реальных документах — проверить с юристом."
        >
  ...
  return (
    <SectionContainer>
      ...
      <Text size="L">
        ...
        должен читаться полностью. Здесь весь набор сюжетов. Большинство
        приехало из Figma вектором; «Важная информация» и «Пример» дизайнер
        прислал картинками (png). Пустым остался только сюжет «AI» — рисунок
        для него ещё не залит.
      </Text>
