    ...
    <>
      ...
      <ContentSection anchor="vstuplenie" title="Вступление">
        <Paragraph>
          ...
          акцент на личности и профессиональных качествах, а не на ограничениях. О
          корректной терминологии — в следующем{" "}
          <SmartLink to="/companies/team">модуле</SmartLink>.
        </Paragraph>

        <Paragraph>
          Человек с инвалидностью имеет такие же возможности трудоустройства, как и
          другие <GlossaryTerm term="соискатель">соискатели</GlossaryTerm>. Он
          может:
        </Paragraph>
        ...
        <BulletList>
          ...
          <li>
            заключать <GlossaryTerm term="договор ГПХ">договор ГПХ</GlossaryTerm>,
          </li>
          <li>
        ...
        <Paragraph>
          <strong>В этом модуле разберём</strong> правовые нюансы: от официального
          трудоустройства со всеми социальными гарантиями до гибких проектных форм
          занятости.
        </Paragraph>
        ...
        <BulletList>
          ...
          <li>
            ...
            <GlossaryTerm term="недееспособность">недееспособности</GlossaryTerm>,
          </li>
          <li>
            сохраняются ли пособия и льготы при оформлении по трудовому договору,
          </li>
          ...
          <li>
            на какие субсидии и меры господдержки могут рассчитывать работодатели,
          </li>
          <li>
