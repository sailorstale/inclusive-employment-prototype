  ...
  return (
    <>
      ...
      <Callout variant="info" title="Этичность">
        ...
        месте, а инвалидность — фактическим обстоятельством. Никаких
        «удивительных историй», никаких «несмотря на».
      </Callout>
      ...
      <Callout variant="info" title="Полный архив">
        Все ~15 историй с фильтрами по сервису, формату и форме инвалидности —
        на{" "}
