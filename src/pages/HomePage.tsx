    ...
    <>
      ...
      <CardGrid cols={3}>
        <Card
          ...
          footer="Инклюзивное трудоустройство · Правила оформления · Наём по шагам · Этика и коммуникация"
        />
        {/*
          В подвале карточки НКО — четыре группы бокового меню раздела, а не все
          четырнадцать его страниц: перечисление на две строки перестаёт
          читаться, а группы дают ту же карту раздела.
        */}
        <Card
          link="internal"
          to="/ngo"
          ...
          footer="Запуск программы · Соискатели · Работодатели · Развитие и масштабирование"
        />
        {/*
