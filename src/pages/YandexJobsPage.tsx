            ...
            >
              <BulletList>
                ...
                <li>
                  ...
                  и кнопки вызова помощи на кофепойнтах для незрячих
                  сотрудников.
                </li>
              </BulletList>
            </Card>
            ...
            >
              <BulletList>
                <li>
                  ...
                  <GlossaryTerm term="РЖЯ">РЖЯ</GlossaryTerm>, обучающие ролики
                  с <GlossaryTerm term="Субтитры">субтитрами</GlossaryTerm>.
                </li>
                <li>
                ...
                <li>Жилеты с визуальной маркировкой для глухих сотрудников.</li>
              </BulletList>
            </Card>
          ...
          <CardGrid cols={3}>
            ...
            >
              <BulletList>
                ...
                <li>Звонки отключены — только чат, доступный всю поездку.</li>
                <li>
