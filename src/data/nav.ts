...
export const mainMenu: { label: string; path: string }[] = [
  ...
  // Вход в редакторский раздел — дашборд правок «Изменения». Маршрут /yandex-jobs
  // из меню убран (страница осталась, на неё ведут ссылки внутри контента).
  { label: "Изменения", path: "/changes" },
];
