...
export const mainMenu: {
  ...
  // Редакторский раздел — отдельное приложение (система редактирования контента,
  // общий сервер на Railway). Внешняя ссылка, открывается в новой вкладке.
  {
    label: "Редактор",
    path: "https://inclusion-editor-production.up.railway.app",
    external: true,
  },
];
